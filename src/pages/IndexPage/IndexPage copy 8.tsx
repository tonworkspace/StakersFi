...
const handleDeposit = async (amount: number) => {
  ...
  return (
    <div className="w-full min-h-screen relative overflow-hidden">
      ...
      <div className="relative mt-[0px] flex items-center justify-between gap-2 px-4 py-2 bg-[#1A1B1E]/50 border-b border-white/5">
        {/* Wallet Balance */}
          ...
          <div className="flex-1 p-4 sm:p-6 space-y-2 overflow-y-auto">
            ...
            <div className="relative overflow-hidden rounded-xl p-4 border border-blue-500/30 shadow-xl mt-5 mb-3 bg-gradient-to-br from-black/80 via-[#0A0A1A] to-[#0A0A1F]">
              ...
              <div className="relative z-10 flex items-center justify-between px-2">
                ...
                >
                  {activeCard === 'community' && (
                    <span className="relative absolute inset-0 bg-gradient-to-r from-purple-600 to-indigo-600 opacity-90"></span>
                  )}
                  <span className="relative flex items-center justify-center gap-2">
  ...
  className="hidden" // Add this line
              ...
              {activeCard === 'community' && (
                <div className="relative bg-black rounded-xl p-custom border border-blue-500/20">                  
                  <div className="space-y-4">
                    {/* Telegram Task */}
