...
// import { MiningSection } from '@/components/MiningSection/MiningSection copy 2';
...
//       {/* Header */}
//       <div className="relatives px-3 py-2 flex justify-between items-center sticky top-0 bg-black/80 backdrop-blur-lg z-50 border-b border-white/5">
//         <div className="flex items-center gap-4">
...
//         {/* Connect Button */}
//         <TonConnectButton className="relatives !bg-blue-500/20 !text-blue-400 hover:!bg-blue-500/30 !rounded-full !transition-all !duration-300 !scale-90" />
//       </div>
...
//             {/* Add Shout Box here */}
//             {/* <div className="relatives bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-xl p-4 border border-blue-500/20">
...
//                     <span className="relative z-10 text-white">Claim</span>
...
// {currentTab === 'tasks' && (
//           <div className="flex-1 mb-10 p-4 sm:p-6 space-y-6 overflow-y-auto">
//              <div className="flex items-center justify-between mb-4">
//       <div className="flex items-center gap-3">
//         <svg className="w-6 h-6 text-white/80" viewBox="0 0 24 24" fill="none" stroke="currentColor">
//           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
//         </svg>
//         <h2 className="text-lg font-medium text-white">Lottery - Get Whitelisted</h2>
//       </div>
//       <a 
...
//                   </div>
//                   <div>
//                     <h3 className="text-xl font-bold text-white">The Staking Snapshot commenced on May 5th, 2025.</h3>
//                     <p className="text-sm text-purple-300/80">May 15, 2025</p>
//                   </div>
//                 </div>
...
//                         <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
//                       </svg>
//                       <span className="text-white/90">🔥 148 NFTs Already Minted — Reveal Coming at 250!</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <svg className="w-5 h-5 text-purple-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                         <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
//                       </svg>
//                       <span className="text-white/90">💎 We’re rolling out major updates for TON Stake It, including a $50,000 Staking/Trading Pool and exciting new app features to boost your Stakers Token earnings.</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <svg className="w-5 h-5 text-purple-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                         <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
