...
// import { RiCpuLine, RiSafeLine } from 'react-icons/ri';  // or you could use RiSafe2Line
...
// import { LootBoxCard2 } from '@/components/LootBoxCard/LootBoxCard2';
...
//   // Inside your IndexPage component
// const handlePurchaseTicket = () => {
//   // Handle purchase logic
//   console.log('Purchase ticket clicked');
// };
...
//       {/* Network Status Bar */}
//       <ShoutboxHeader />
//       <div className="mt-[32px] flex items-center justify-between gap-2 px-4 py-2 bg-[#1A1B1E]/50 border-b border-white/5">
//         {/* Wallet Balance */}
...
//           {/* Network Badge */}
//           <div className={`relative px-2 py-1 rounded-full flex items-center gap-1.5 ${
//             isMainnet 
...
//             <div className="relative overflow-hidden p-4 mb-2 bg-gradient-to-br from-blue-900/40 to-indigo-900/40 rounded-xl border border-blue-400/30 shadow-lg backdrop-blur-sm">
...
//           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
//         </svg>
//         <h2 className="text-lg font-medium text-white">Lootbox</h2>
//       </div>
//       <a 
//                   href="https://t.me/tonstakeit" 
//                   target="_blank" 
...
//               { id: 'stake', text: 'Stake', Icon: RiSafeLine },
//               { id: 'gmp', text: 'Top', Icon: FaTrophy },
//               { id: 'tasks', text: 'Play', Icon: BsNewspaper }, 
