...
export const ShoutboxHeader: FC<{ onTabChange?: (tab: string) => void }> = ({ onTabChange }) => {
  const [shoutboxMessages] = useState([
    { text: "The Snapshot has begun since May 5, 2025 – be sure to participate by purchasing tickets! 🎟️" },
    { text: "New mining hardware is coming soon! ⚡" },
    { text: "Join the mining pool for consistent rewards! 🌊" }
  ]);
  ...
  return (
    <div className="relative top-0 left-0 right-0 z-50 bg-gradient-to-r from-blue-400 to-blue-600 overflow-hidden h-8 shadow-lg">
      <div className="relative flex items-center h-full">
        ...
        <div className="absolute right-4 top-1/2 -translate-y-1/2 z-10">
          <button 
            className="px-3 py-0.5 text-xs bg-white text-blue-600 rounded-full 
                     hover:bg-blue-50 transition-colors duration-200 font-semibold
